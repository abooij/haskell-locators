...
locatesLeft l q r = case l q r of LocatesLeft _ -> True; _ -> False
locatesRight :: RL -> Rational -> Rational -> Bool
locatesRight l q r = case l q r of LocatesRight _ -> True; _ -> False
